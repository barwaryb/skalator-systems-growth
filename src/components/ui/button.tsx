  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Premium variants for Skalator
        premium: "bg-primary text-primary-foreground rounded-none hover:bg-primary/85 font-body tracking-wide",
        "premium-outline": "border border-primary/20 bg-transparent text-foreground rounded-none hover:border-primary/40 hover:bg-primary/5 font-body tracking-wide",
      },
      size: {
        ...
        "premium-lg": "h-14 px-10 py-4 text-base",
      },
    },
    defaultVariants: {
      variant: "default",

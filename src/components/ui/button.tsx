  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent: "bg-accent text-accent-foreground font-semibold hover:brightness-105 shadow-lg shadow-accent/25",
        // Premium outline
        "premium-outline": "border-2 border-foreground/20 bg-transparent text-foreground hover:border-foreground/40 hover:bg-foreground/5 font-medium",
      },
      size: {
        ...
        icon: "h-10 w-10",
        // Premium sizes
        premium: "h-14 px-8 py-4 text-base rounded-full",
        "premium-lg": "h-16 px-10 py-4 text-lg rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",

      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <h2 className="text-display font-display font-bold text-foreground">
            <span className="font-serif italic text-foreground-muted">Skalator</span>{" "}
            <span className="text-accent inline-block animate-pulse-glow">
              =
            </span>{" "}
            <span className="font-serif italic text-foreground-muted">Skalierung</span> + <span className="font-serif italic text-foreground-muted">Automatisierung</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="relative inline-block">
            ...
            <p className="relative text-headline font-display font-bold text-foreground mb-8 max-w-3xl mx-auto">
              Mit mir skalierst du wirklich deinen <span className="font-serif italic text-emerald-400">Umsatz</span> – und senkst automatisiert deine <span className="font-serif italic text-red-400">Kosten</span>.
            </p>
          </div>
